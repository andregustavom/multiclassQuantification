...
def prep_data(binned = False):
  ...
  url = urllib.request.urlopen("https://archive.ics.uci.edu/ml/machine-learning-databases/00275/Bike-Sharing-Dataset.zip", cafile=certifi.where())
  ...
  labels = [1, 2, 3, 4]
  dta['label'] = pd.cut(dta['cnt'], bins = bins, labels = labels)
